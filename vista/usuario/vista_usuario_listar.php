...
<!-- Modal registrar directorio-->
<form autocomplete="false" onsubmit="return false">
    <div class="modal fade bd-example-modal-sm" tabindex="-1" role="dialog" id="ModalEditar">
      <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">Registro de Directorio</h5>
          ...
          <div class="modal-body">
            ...
            <div class="input-group">
                  ...
                  <input type="text" id="txtiddirectorio">
                  <select class="js-example-basic-single" name="state" id="select_fiscal_editar" style="width:100%;">
            ...
            <div class="input-group">
                  ...
                  <select class="js-example-basic-single" name="state" id="select_despacho_editar" style="width:100%;" disabled>
                  </select>
            </div>
            <br>
            <div class="input-group" >
                  ...
                  <input type="text" class="form-control" id="txtdireccion_editar" placeholder="Direccion"/>
            </div>
            <br>
            <div class="input-group" >
                  <span class="input-group-addon">
                  ...
                  <input type="text" class="form-control" id="txttelefono_editar" placeholder="Telefono"/>
            </div>
            <br>
            ...
            <div class="input-group">
                  ...
                  <select class="js-example-basic-single" name="state" id="select_estatus_editar" style="width:100%;">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-primary" onclick="editar_directorio();"><i class="fa fa-check"><b>&nbsp;Registrar</b></i></button>
            <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fa fa-close"><b>&nbsp;Cerrar</b></i></button>
          </div>
        </div>
      </div>
