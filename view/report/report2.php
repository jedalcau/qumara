...
$data = $consulta->Atenciones2($fechainicio,$fechafin);
...
$pdf->Cell(130,10,"Fecha Final: ". $fechafin,0,0,"C",0);
...
$pdf->Cell(30,10,"Fec. Consulta",1,0,"C",1);
$pdf->Cell(30,10,"Hora Consulta",1,0,"C",1);
$pdf->Ln();
$i = 1;
while($fila=$data->fetch_array(MYSQLI_ASSOC))
{
    ...
    $pdf->Cell(30,10,$fila['fecconsulta'],1,0,'L',1);
    $pdf->Cell(30,10,$fila['horaconsulta'],1,0,'L',1);
    $i++;
    $pdf->Ln();
}
