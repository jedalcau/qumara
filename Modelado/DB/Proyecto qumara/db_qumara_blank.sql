...
CREATE TABLE T_LOGIN (
  IN_ID_LOG INT (11) NOT NULL AUTO_INCREMENT COMMENT 'ID Tabla Login',
...
CREATE TABLE T_EXPERIENCIA_PSA (
  ...
  CONSTRAINT FK_EXPERIENCIA_PSALUD_1 FOREIGN KEY (IN_CODIGO_PSA) REFERENCES T_PERSONAL_SALUD (IN_CODIGO_PSA) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT 'Tabla Experiencia Personal de Salud';

CREATE TABLE T_CITA (
  IN_ID_CIT INT (11) NOT NULL AUTO_INCREMENT,
  VC_CODIGO_CIT VARCHAR (20) NOT NULL,
  ...
  KEY FK_CITA_CONSULTORIO_1 (IN_ID_CON),
  KEY FK_CITA_PSALUD_1 (IN_ID_PSA),
