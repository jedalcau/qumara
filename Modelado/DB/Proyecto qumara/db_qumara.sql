...
TODO: me quede aqui
SELECT IN_ID_PSA AS idPSalud, VC_DNI_PSA AS dniPSalud, VC_NOMBRE_PSA AS nomPSalud, VC_APELLIDO_PSA AS apePSalud, VC_EMAIL_PSA AS , VA_FNACIMIENTO_PSA, VC_GENERO_PSA, VC_DIRECCION_PSA, VC_DEPARTAMENTO_PSA, VC_PROVINCIA_PSA, VC_DISTRITO_PSA, VC_PROFESION_PSA, VC_COLEGIATURA_PSA, VC_TELEFONO_PSA, VC_AVATAR_PSA, VC_BIOGRAFIA_PSA, DT_FREGISTRO_PSA, TI_ESTADO_PSA, IN_OCULTO_PSA, VC_FIRMA_PSA
FROM T_PERSONAL_SALUD;
