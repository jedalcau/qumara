<?php 
    ...
    $modelo_Consultorio = new Consultorio();
    $mostrar_Consultorio = $modelo_Consultorio->mostrarConsultorio();
 ?>
                                                ...
                                                <td class="text-right">
                                                    <div class="dropdown dropdown-action">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a class="dropdown-item" href="edit-department.php?idconsultorio=<?php /*echo $fila['idconsultorio'];*/?>"><i class="fa fa-pencil m-r-5"></i> Editar</a>
