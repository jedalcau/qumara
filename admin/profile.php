...
if(isset($_SESSION['administrator']))
{
    ...
    $doctor = $doctores->Mostrardoctor($iddoc);
    
    $grados = $doctores->ListEducation($iddoc);
    $experiencia = $doctores->ListExperiencia($iddoc);
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form id="formularioExperiencia">
          <div class="form-group">
            <input type="hidden" name="iddoc1" id="iddoc1" value="<?php echo $iddoc; ?>">
          ...
          <div class="form-inline">
                ...
                <div class="form-group mb-2">
                    <input type="text" class="form-control" id="diainicio" name="diainicio" aria-describedby="diainicioHelp" size="3" placeholder="dia">
                    ...
                    <input type="number" name="txtanio1" class="form-control" id="txtanio1" placeholder="Año">
                </div>
          ...
          <div class="form-inline">
              ...
              <div class="form-group mb-2">
                  <input type="text" class="form-control" id="diafin" name="diafin" aria-describedby="fechainicioHelp" size="3" placeholder="dia">
                    <select name="cbomesfin" id="cbomesfin" class="form-control">
                        <option value="" disabled selected>[Seleccionar]</option>
                        <option value="1">Enero</option>
                        <option value="2">Febrero</option>
                        <option value="3">Marzo</option>
                    ...
                    <input type="number" class="form-control" name="txtanio2" id="txtanio2" placeholder="Año">
              </div>
            
          </div>

          <div class="form-inline">
              <input type="checkbox" class="form-check-input" name="presente" id="presente">
              <label class="form-check-label" for="presente">Sigo trabajando en este lugar</label>
          </div>
