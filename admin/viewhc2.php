                    ...
                    <div class="col-sm-12 col-3">
                        ...
                        <form method="post">
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="txtpaciente" id="txtpaciente" value="" readonly>
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                    <div class="form-group">
                            ...
                            <div class="m-t-20 text-center">
                                ...
                                <a href="report/receta.php?idhc=<?php echo $idhc;?>" target="_blank" class="btn btn-warning submit-btn">Imprimir Receta</a>
